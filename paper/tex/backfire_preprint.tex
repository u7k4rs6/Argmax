...
% The header is qualified for v2: the workshop accepted v1, and v2 carries
% material no reviewer saw, including a correction to the accepted version's
% mechanism section. See the acceptance note below the title.
\lhead{v1 accepted at the COLM 2026 Workshop on Efficient Reasoning; v2 additions not peer reviewed}
